...
class MagickConan(ConanFile):
    ...
    def source(self):
        self.run("git clone --recursive https://github.com/ImageMagick/ImageMagick.git --branch %s" % (self.version))
    ...
    def build(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="./ImageMagick")
        cmake.build()
        return
